...
public class CommandHelp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        par1ICommandSender.func_70006_a("\u00a72" + par1ICommandSender.translateString("commands.help.header", new Object[] {Integer.valueOf(var11 + 1), Integer.valueOf(var5 + 1)}));

        for (int var12 = var11 * var4; var12 < var7; ++var12)
        {
            var9 = (ICommand)var3.get(var12);
            par1ICommandSender.func_70006_a(var9.getCommandUsage(par1ICommandSender));
        }

        if (var11 == 0)
        {
            par1ICommandSender.func_70006_a("\u00a7a" + par1ICommandSender.translateString("commands.help.footer", new Object[0]));
        }
    }

    protected List func_71534_d(ICommandSender par1ICommandSender)
    {
        List var2 = MinecraftServer.getServer().func_71187_D().func_71557_a(par1ICommandSender);
    ...
    {
        return MinecraftServer.getServer().func_71187_D().func_71555_a();
    }
}
