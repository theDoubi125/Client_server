...
public class WorldManager implements IWorldAccess
{
    ...
    {
        this.world.getEntityTracker().trackEntity(par1Entity);
    }
    ...
    {
        this.world.getEntityTracker().untrackEntity(par1Entity);
    }
    ...
    {
        this.world.func_73040_p().markBlockNeedsUpdate(par1, par2, par3);
    }
    ...
    public void destroyBlockPartially(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        while (var6.hasNext())
        {
            ...
            if (var7 != null && var7.worldObj == this.world && var7.entityId != par1)
            {
