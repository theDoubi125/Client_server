...
public class NetServerHandler extends NetHandler
{
    ...
    public void handlePackets()
    {
        ...
        if ((long)this.field_72571_f - this.field_72580_l > 20L)
        {
            ...
            this.field_72585_i = rndmObj.nextInt();
            this.sendPacket(new Packet0KeepAlive(this.field_72585_i));
        }
        ...
        if (!this.playerEntity.gameOver)
        {
            ...
            if (this.hasMoved)
            {
                ...
                if (this.playerEntity.ridingEntity != null)
                {
                    ...
                    if (this.playerEntity.ridingEntity != null)
                    {
                        var2.func_73050_b(this.playerEntity.ridingEntity, true);
                    }
                ...
                if (!this.mcServer.func_71231_X() && !this.playerEntity.theItemInWorldManager.isCreative() && !var2.isAABBNonEmpty(var33))
                {
                    if (var29 >= -0.03125D)
                    {
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        else
        {
            ...
            {
                this.playerEntity.theItemInWorldManager.func_73073_c(var5, var6, var7);
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        if (var3 == null || var3.getMaxItemUseDuration() == 0)
        {
            ...
            Slot var13 = this.playerEntity.craftingInventory.func_75147_a(this.playerEntity.inventory, this.playerEntity.inventory.currentItem);
    ...
    public void handleUseEntity(Packet7UseEntity par1Packet7UseEntity)
    {
        ...
        if (var3 != null)
        {
            ...
            if (this.playerEntity.getDistanceSqToEntity(var3) < var5)
            {
                ...
                {
                    this.playerEntity.func_70998_m(var3);
                }
    ...
    {
        if (par1Packet0KeepAlive.randomId == this.field_72585_i)
        {
    ...
    {
        this.playerEntity.capabilities.isFlying = par1Packet202PlayerAbilities.func_73350_f() && this.playerEntity.capabilities.allowFlying;
    }
    ...
    {
        this.playerEntity.func_71125_a(par1Packet204ClientInfo);
    }
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
        ...
        else if ("MC|BSign".equals(par1Packet250CustomPayload.channel))
        {
            try
            {
                ...
                if (var3 != null && var3.itemID == Item.field_77823_bG.shiftedIndex && var4.itemID == Item.writableBook.shiftedIndex)
                {
                    var4.setTagCompound(var3.getTagCompound());
