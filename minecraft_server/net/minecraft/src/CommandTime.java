...
public class CommandTime extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length > 1)
        {
            ...
            if (par2ArrayOfStr[0].equals("set"))
            {
                ...
                func_71522_a(par1ICommandSender, "commands.time.set", new Object[] {Integer.valueOf(var3)});
                return;
            }
            ...
            if (par2ArrayOfStr[0].equals("add"))
            {
                ...
                func_71522_a(par1ICommandSender, "commands.time.added", new Object[] {Integer.valueOf(var3)});
                return;
            }
        }
    ...
    {
        for (int var3 = 0; var3 < MinecraftServer.getServer().worldMngr.length; ++var3)
        {
            MinecraftServer.getServer().worldMngr[var3].setTime((long)par2);
        }
    }
    ...
    protected void addTime(ICommandSender par1ICommandSender, int par2)
    {
        for (int var3 = 0; var3 < MinecraftServer.getServer().worldMngr.length; ++var3)
        {
            WorldServer var4 = MinecraftServer.getServer().worldMngr[var3];
