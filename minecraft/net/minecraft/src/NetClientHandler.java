...
import cartasiane.spells.packets.Packet150TargetInfos;
import cartasiane.spells.packets.Packet151Spell;
...
public class NetClientHandler extends NetHandler
{
    ...
    {
        mc.playerControllerMP = new PlayerControllerMP(mc, this);
        ...
        mc.thePlayer.dimension = par1Packet1Login.field_73558_e;
        mc.displayGuiScreen(new GuiDownloadTerrain(this));
        mc.thePlayer.entityId = par1Packet1Login.field_73561_a;
        currentServerMaxPlayers = par1Packet1Login.maxPlayers;
        mc.playerControllerMP.func_78746_a(par1Packet1Login.field_73557_d);
    ...
    public void handleRespawn(Packet9Respawn par1Packet9Respawn)
    {
        ...
        {
            doneLoadingTerrain = false;
            worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet9Respawn.field_73369_d, false, mc.theWorld.getWorldInfo().isHardcoreModeEnabled(), par1Packet9Respawn.terrainType), par1Packet9Respawn.respawnDimension, par1Packet9Respawn.difficulty, mc.field_71424_I);
            worldClient.isRemote = true;
            mc.func_71403_a(worldClient);
        ...
        mc.playerControllerMP.func_78746_a(par1Packet9Respawn.field_73369_d);
    }
    ...
    {
        mc.theWorld.sendClientEvent(par1Packet54PlayNoteBlock.xLocation, par1Packet54PlayNoteBlock.yLocation, par1Packet54PlayNoteBlock.zLocation, par1Packet54PlayNoteBlock.field_73335_f, par1Packet54PlayNoteBlock.instrumentType, par1Packet54PlayNoteBlock.pitch);
    }

    public void func_72465_a(Packet55BlockDestroy par1Packet55BlockDestroy)
    {
        mc.theWorld.func_72888_f(par1Packet55BlockDestroy.func_73322_d(), par1Packet55BlockDestroy.func_73321_f(), par1Packet55BlockDestroy.func_73324_g(), par1Packet55BlockDestroy.func_73320_h(), par1Packet55BlockDestroy.func_73323_i());
    }
    ...
    public void handleBed(Packet70GameEvent par1Packet70GameEvent)
    {
        ...
        {
            mc.playerControllerMP.func_78746_a(EnumGameType.func_77146_a(j));
        }
        else if (i == 4)
        {
    ...
    {
        mc.theWorld.func_72980_b(par1Packet62LevelSound.func_73572_f(), par1Packet62LevelSound.func_73568_g(), par1Packet62LevelSound.func_73569_h(), par1Packet62LevelSound.func_73570_d(), par1Packet62LevelSound.func_73571_i(), par1Packet62LevelSound.func_73573_j());
    }
    ...
    public void handleTargetInfos(Packet150TargetInfos packet)
    {
    	if(packet.answer)
    	{
    		EntityLiving entity = (EntityLiving)getEntityByID(packet.id);
    		entity.experienceLevel = packet.level;
    		entity.health = packet.health;
    		if(entity instanceof EntityPlayer)
    			((EntityPlayer)entity).mana = packet.mana;
    	}
    }
}
