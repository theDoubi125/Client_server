...
public abstract class Render
{
    ...
    public void doRenderShadowAndFire(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if(par1Entity.isTargeted())
        	renderTargetAroundEntity(par1Entity, par2, par4, par6, par9);
    }
    ...
    /** doubi125 */
    private void renderTargetAroundEntity(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        GL11.glDepthMask(false);
        GL11.glDisable(GL11.GL_LIGHTING);
    	GL11.glEnable(GL11.GL_BLEND);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)par2, (float)par4, (float)par6);
        loadTexture("/gui/spells.png");
        Tessellator tessellator = Tessellator.instance;
        float f9 = par1Entity.height;
        float f10 = 0.0F;
        float f11 = par1Entity.height;
        float f12 = (float)(par1Entity.posY - par1Entity.boundingBox.minY);
        GL11.glRotatef(-renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
        GL11.glTranslatef(0.0F, 0.0F, -0.3F + (float)(int)f11 * 0.02F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        tessellator.addVertexWithUV(f9 - f10, 0.0F - f12, f13, 240F/256F, 239F/256F);
        tessellator.addVertexWithUV(-f9 - f10, 0.0F - f12, f13, (240F+16f)/256F, 239F/256F);
        tessellator.addVertexWithUV(-f9 - f10, 1.4F - f12, f13, (240F+16f)/256F, (239F+16f)/256F);
        tessellator.addVertexWithUV(f9 - f10, 1.4F - f12, f13, 240F/256F, (239F+16f)/256F);
