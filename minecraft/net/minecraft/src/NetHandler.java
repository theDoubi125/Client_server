...
public abstract class NetHandler
{
    ...
    {
        registerPacket(par1Packet56MapChunks);
    }
    
    public void handleTargetInfos(Packet150TargetInfos packet150TargetInfos) 
    {
    	registerPacket(packet150TargetInfos);
    }
	...
	public void handleSpell(Packet151Spell packet151Spell)
	{
		registerPacket(packet151Spell);
	}
}
