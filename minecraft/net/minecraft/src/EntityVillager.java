        ...
        switch (getProfession())
        {
            ...
            case 2:
                ...
                for (int k = 0; k < j; k++)
                {
                    ...
                    {
                        merchantrecipelist.add(new MerchantRecipe(new ItemStack(l, 1, 0), new ItemStack(Item.diamond, 2 + rand.nextInt(3), 0), EnchantmentHelper.func_77504_a(rand, new ItemStack(l, 1, 0), 5 + rand.nextInt(15))));
                    }
                }
