...
public class PlayerControllerMP
{
    ...
    {
        if (!par0Minecraft.theWorld.func_72886_a(par0Minecraft.thePlayer, par2, par3, par4, par5))
        {
    ...
    public void func_78746_a(EnumGameType par1EnumGameType)
    {
        ...
        field_78779_k.func_77147_a(field_78776_a.thePlayer.capabilities);
    }
    ...
    public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4)
    {
        ...
        WorldClient worldclient = field_78776_a.theWorld;
        ...
        {
            ItemStack itemstack = field_78776_a.thePlayer.getCurrentEquippedItem();

            if (itemstack != null)
            {
                itemstack.func_77941_a(worldclient, block.blockID, par1, par2, par3, field_78776_a.thePlayer);

                if (itemstack.stackSize == 0)
                {
                    field_78776_a.thePlayer.destroyCurrentEquippedItem();
                }
            }
        }
    ...
    public void clickBlock(int par1, int par2, int par3, int par4)
    {
        ...
        {
            netClientHandler.addToSendQueue(new Packet14BlockDig(0, par1, par2, par3, par4));
            int i = field_78776_a.theWorld.getBlockId(par1, par2, par3);

            if (i > 0 && curBlockDamageMP == 0.0F)
            {
                Block.blocksList[i].onBlockClicked(field_78776_a.theWorld, par1, par2, par3, field_78776_a.thePlayer);
            }

            if (i > 0 && Block.blocksList[i].func_71908_a(field_78776_a.thePlayer, field_78776_a.thePlayer.worldObj, par1, par2, par3) >= 1.0F)
            {
            ...
            else
            {
                ...
                prevBlockDamageMP = 0.0F;
                stepSoundTickCounter = 0.0F;
                field_78776_a.theWorld.func_72888_f(field_78776_a.thePlayer.entityId, currentBlockX, currentBlockY, currentblockZ, (int)(curBlockDamageMP * 10F) - 1);
            }
        }
    }
    ...
    public void resetBlockRemoving()
    {
        ...
        isHittingBlock = false;
        curBlockDamageMP = 0.0F;
        field_78776_a.theWorld.func_72888_f(field_78776_a.thePlayer.entityId, currentBlockX, currentBlockY, currentblockZ, -1);
    }
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (par1 == currentBlockX && par2 == currentBlockY && par3 == currentblockZ)
        {
            ...
            curBlockDamageMP += block.func_71908_a(field_78776_a.thePlayer, field_78776_a.thePlayer.worldObj, par1, par2, par3);
    ...
    {
        int i = field_78776_a.thePlayer.inventory.currentItem;
    ...
    /** doubi125 */
	public void targetEntity(EntityPlayer player, EntityLiving target)
	{
		netClientHandler.addToSendQueue(new Packet150TargetInfos(target.entityId));
	...
	{
		player.castSpell();
		Spell spell = player.spells.getCurrentSpell();
		netClientHandler.addToSendQueue(new Packet151Spell(player, spell));
	}
}
