...
public class RenderIronGolem extends RenderLiving
{
    ...
    public RenderIronGolem()
    {
        ...
        this.field_77050_a = (ModelIronGolem)this.mainModel;
    }

    public void func_77049_a(EntityIronGolem par1EntityIronGolem, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRenderLiving(par1EntityIronGolem, par2, par4, par6, par8, par9);
    }

    protected void func_77048_a(EntityIronGolem par1EntityIronGolem, float par2, float par3, float par4)
    {
    ...
    protected void func_77047_a(EntityIronGolem par1EntityIronGolem, float par2)
    {
        ...
        if (par1EntityIronGolem.getHoldRoseTick() != 0)
        {
            ...
            GL11.glPushMatrix();
            GL11.glRotatef(5.0F + 180.0F * this.field_77050_a.ironGolemRightArm.rotateAngleX / (float)Math.PI, 1.0F, 0.0F, 0.0F);
    ...
    {
        this.func_77047_a((EntityIronGolem)par1EntityLiving, par2);
    }

    protected void rotateCorpse(EntityLiving par1EntityLiving, float par2, float par3, float par4)
    {
        this.func_77048_a((EntityIronGolem)par1EntityLiving, par2, par3, par4);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.func_77049_a((EntityIronGolem)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.func_77049_a((EntityIronGolem)par1Entity, par2, par4, par6, par8, par9);
    }
}
