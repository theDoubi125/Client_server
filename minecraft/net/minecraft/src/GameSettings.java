...
public class GameSettings
{
    ...
    public KeyBinding keyBindSpellSelect;
    public KeyBinding keyShowSpells;
    ...
    public GameSettings(Minecraft par1Minecraft, File par2File)
    {
        ...
        keyBindSpellSelect = new KeyBinding("key.selectspell", 46);
        keyShowSpells = new KeyBinding("key.showspell", 47);
        ...
        keyBindings = (new KeyBinding[]
                {
                    ...
                    keyBindChat, keyBindPlayerList, keyBindPickBlock, keyBindSpellSelect, keyShowSpells, field_74323_J
                });
        difficulty = 2;
        hideGUI = false;
        thirdPersonView = 0;
    ...
    public void saveOptions()
    {
        ...
        {
            mc.thePlayer.sendQueue.addToSendQueue(new Packet204ClientInfo(language, renderDistance, field_74343_n, field_74344_o, difficulty));
        }
    }
